...
public class TipContentView extends AppCompatTextView {
    ...
    private void init(Context context) {
        ...
        screenWidth = mScreenUtil.screenWidth();
        screenHeight = mScreenUtil.screenHeight();
    }
    ...
    private void checkLocation() {
        if (mY < mScreenUtil.screenHeight() / 2) {
            this.inTop = true;
        }else{
            this.inTop = false;
        }
